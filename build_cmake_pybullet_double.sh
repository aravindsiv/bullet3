...
cmake -E env CXXFLAGS="-fPIC" cmake -DBUILD_PYBULLET=OFF -DBUILD_PYBULLET_NUMPY=OFF DUSE_DOUBLE_PRECISION=ON -DBT_USE_EGL=ON -DCMAKE_INSTALL_PREFIX=$DIRTMP_PATH .. || exit 1
